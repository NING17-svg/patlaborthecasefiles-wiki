# PATLABOR the Case Files Wiki

This is the launch-day en-US reference site for **PATLABOR the Case Files** (Steam AppID 3275400, developer Chime Corporation, publisher GOOD SMILE COMPANY, released 2026-09-16 on Windows 64-bit). It is generated from the V3 Next.js seed template by the `one-click-builder` role and serves approved content, the completed dark dispatch-room theme specification, fixed-page assembly from the SEO content package, and Cloudflare Workers Static Assets deployment.
